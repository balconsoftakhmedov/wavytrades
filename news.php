...
<div class="d-lg-flex d-grid mb-5 justify-content-center align-items-center">
    <?php ?>
    <div class="d-flex align-items-center mx-3" style="max-width: 500px; width: 100%">
        <form action="/" data-ajax_url="" method="get"
            ...
            <input type="hidden" name="cat_name" class="form-control" value="news">
        </form>
    </div>
</div>
...
<div class="container-lg">
    ...
    <div id="more_posts_news" class="btn btn-dark more_posts"><span class="btn_span_ajax">Load More</span>
