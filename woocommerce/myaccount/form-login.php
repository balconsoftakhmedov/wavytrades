            ...
            <div class="dashboard__content">
                <div class="dashboard__content-main">
                    <section class="dashboard__content-section">
                        <div class="woocommerce">
                            ...
                            <div class="dashboard__login-container">
                                ...
                                <div class="u-columns col2-set " id="customer_login">
                                        ...
                                        <!--                                        <h2>-->
                                        <?php //esc_html_e('Login', 'woocommerce'); ?><!--</h2>-->
                                        ...
                                        <form class="woocommerce-form woocommerce-form-login login" method="post">
                                            ...
                                            <div class="content-box content-box--centered">
                                                <div class="content-box__section">
                                                    <div class="row">
                                                            <h2 class="h3 text-center title" style='font-family: -apple-system,system-ui,BlinkMacSystemFont,"Segoe UI",Helvetica,Arial,sans-serif,"Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol";'>Login to your
                                                                Dashboard</h2>
                                                            <p class="text-center" style='font-family: -apple-system,system-ui,BlinkMacSystemFont,"Segoe UI",Helvetica,Arial,sans-serif,"Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol";'>Access your member exclusive content,
                                                                classes and indicators.</p>
                                                    </div>
                                                    ...
                                                    <div class="form-group form-submit-part">
                                                        <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                        ...
                        <div class="u-column2 stm-dontshow " id="customer_register">
...
<!--                            </form>-->
                            ...
                            <form method="post" style="border: none;" class="woocommerce-form woocommerce-form-register register " <?php do_action('woocommerce_register_form_tag'); ?> >
