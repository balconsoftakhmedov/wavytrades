...
?>
<form class="woocommerce-form woocommerce-form-login login stm-login-checkout" method="post" <?php echo ( $hidden ) ? 'style="display:none;"' : ''; ?>>
    ...
    <p class="lost_password" style="padding-left: 20px">
